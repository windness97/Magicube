...
def relocateTopLayerTXB(info):
    ...
    for i in range(abs(numRotations)):
...
def topCrossBeginner(state, topLayer):
    moves = []
...
def topCornersBeginner(state, topLayer):
    moves = []
...
def secondLayerBeginner(state, topLayer):
    moves = []
...
def thirdLayerCornerOrientation(state, topLayer):
    moves = []
    ...
    while count > 0:
        ...
        try:
            ...
            print("facingXs=%s, facingYs%s, facingDowns%s" % (facingXs, facingYs, facingDowns))
            break
...
def thirdLayerEdgeOrientation(state, topLayer):
    moves = []
...
def thirdLayerCornerPermutation(state, topLayer):
    moves = []
    ...
    while count > 0:
        ...
        for i in range(len(bottomCorners)):
...
def thirdLayerEdgePermutation(state, topLayer):
    moves = []
